...
IMAGE_FOLDER = r"C:\Users\HP\OneDrive\Desktop\Talking finger\images"  # Ensure images are high-quality & named as A.jpg, B.jpg, ..., Z.jpg
...
def audio_to_text():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            st.write("⚠ Could not request results from Google API.")
    ...
    for word in isl_sentence:
        ...
        for letter in word:
            ...
            if os.path.exists(letter_image):
                ...
                st.write(f"⚠ No image found for '{letter}'")
        ...
        for img_path in word_images:
            ...
            time.sleep(0.2)  # Pause between letters (0.5 sec)
